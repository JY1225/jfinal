...
function(e) {
    ...
    u = function() {
        this.config = {
            verify: {
            	timmersql:[/(.*发送人.*接收人.*消息内容.*链接地址.*)/, "（发送人，接收人，消息内容，链接地址） 字段固定"],
                required: [/[\S]+/, "必填项不能为空"],
                    ...
                    if (!u) {
                        ...
                        function(e) {
                            ...
                            var i = function(t, a) {
                                ...
                                return l = r[t](),
                                n = r[t]("dd:not(." + o + ")"),
                                l[0] ? (y = r[t](), n[0] && !n.hasClass(c) || !y[0] ? (n.addClass(s).siblings().removeClass(s), void $()) : i(t, y)) : y = null
                            };
                            38 === t && i("prev"),
                            40 === t && i("next"),
                            13 === t && (e.preventDefault(), x.children("dd." + s).trigger("click"))
                        });
                        ...
                        var T = function(e, i, a) {
                            ...
                            function() {
                                ...
                                l = i.text(),
//                              r = l.indexOf(e) === -1; 
                                id = i.attr("layui-value"),
                                r = myFilter(e, l, id);("" === e || "blur" === a ? e !== l: r) && n++,
                        ...
                        j = function(e) {
                            var t = this.value,
                            i = e.keyCode;
                            return 9 !== i && 13 !== i && 37 !== i && 38 !== i && 39 !== i && 40 !== i && (T(t,
                            function(e) {
        ...
        function(e, l) {
            ...
            function(e, t) {
                ...
                if (a[t]) {
                    ...
                    if (f = f || a[t][1], c) return "tips" === u ? i.tips(f,
                    function() {
